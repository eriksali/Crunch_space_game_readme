...
public class Division extends App {
    ...
    Division(TextField resu1lt, Label answer, Label question, Text flag) {
    ...
    public void loadText(Pane gp) {
        ...
        Label answertxt = new Label("Round to nearest whole number");
        ...
        answertxt.setLayoutX(60);
        answertxt.setLayoutY(170);
    ...
    public void submitBtn(Pane gp) {
        number1 = rand.nextInt(10, 20);
        number2 = rand.nextInt(1, 10);
            ...
            if (counter < LEVEL) {
                try {
                    ...
                    if (resu1lt.getText().isEmpty()) {
                        ...
                        resu1 = Math.round(number1 / number2);
